...
function EnhancedTableBody({rows, order, orderBy, selected, onCheckboxClick, authenticated}) {
  ...
  {rows
    ...
    .map((row) => {
      ...
      return (
        ...
        >
          {authenticated && <TableCell padding="checkbox">
            <Checkbox
              color="secondary"
          ...
          <TableCell align="left" sx={{width: '10rem'}}><ChipStatus status={row.status}/></TableCell>
          <TableCell align="left">
